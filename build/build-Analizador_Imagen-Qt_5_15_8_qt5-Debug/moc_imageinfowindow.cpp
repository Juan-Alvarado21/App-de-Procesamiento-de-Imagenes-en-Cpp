...
#include <memory>
#include "../Analizador_Imagen/imageinfowindow.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ImageInfoWindow_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ImageInfoWindow_t qt_meta_stringdata_ImageInfoWindow = {
    {
QT_MOC_LITERAL(0, 0, 15) // "ImageInfoWindow"
...
QT_INIT_METAOBJECT const QMetaObject ImageInfoWindow::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_ImageInfoWindow.data,
    qt_meta_data_ImageInfoWindow,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ImageInfoWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ImageInfoWindow.stringdata0))
